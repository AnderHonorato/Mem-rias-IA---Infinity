# Logs operacionais da Manus

Registre aqui apenas eventos operacionais resumidos: sincronização, falhas de push, criação ou atualização de skills e decisões de roteamento que sejam úteis para diagnóstico. Não registre credenciais nem o conteúdo integral de conversas.
